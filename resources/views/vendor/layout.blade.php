...
<head>
    ...
    <title>Ecommerce Vendor Dashboard</title>
    <!-- plugins:css -->
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item dropdown d-none d-xl-inline-block">
                        <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                            <span class="profile-text">{{Auth::guard('vendor')->user()->vendor_name}}</span>
                        ...
                        <div class="nav-link">
                            <div class="user-wrapper">
                                ...
                                <div class="text-wrapper">
                                    <p class="profile-name">{{Auth::guard('vendor')->user()->vendor_name}}</p>
                                    <div>
                                        <small class="designation text-muted">{{Auth::guard('vendor')->user()->store_name}}</small>
